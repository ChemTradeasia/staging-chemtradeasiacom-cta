...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <section style="margin-top:70px">
            <div class="container-fluid" style="padding:0px;background-color:#123c69;color:#ffffff">
                <div class="container">
                    <div class="row" style="padding: 10px 0px;">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" style="width: fit-content;text-align: center;">
                            <img src="https://cdn.chemtradeasia.com/cms/vision.png">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <h2 style="font-family: GenghisKhan;font-size: 35px;text-align:center"><b>OUR VISION</b></h2>
                            <p style="text-align:center">To be a reliable and trustworthy partner in the global supply chain of raw materials</p>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" style="width: fit-content;text-align: center;">
                            <img src="https://cdn.chemtradeasia.com/cms/mission1.png">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <h2 style="font-family: GenghisKhan;font-size: 35px;text-align:center"><b>OUR MISSION</b></h2>
                            <p style="text-align:center">To supply good quality products and services delivered using effective supply chain solutions while providing profitable and sustainable growth to all our stakeholders</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section style="padding:20px 0px">
            <div class="container">
                <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b>VISION, MISSION & SHARE VALUES</b></h2>
                <hr style="text-align:center;width:10%;border-top:5px solid #113c69;" />            
                <div class="banner" style="position:relative;">
                    <center><img alt="Newsletter" src="https://cdn.chemtradeasia.com/cms/value_platform.png" style="width:100%" /></center>
                </div>
            </div>
        </section>
        ...
        <section style="padding:20px 0px">
            <div class="container">
                <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b>OUR VALUES</b></h2>
                <hr style="text-align:center;width:10%;border-top:5px solid #113c69;" />            
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4" style="margin: 10px 0px;">
                            <div class="card" style="padding: 1.25rem;min-height:362px">
                                <img src="https://cdn.chemtradeasia.com/cms/Group 13.png" alt="Card image" style="width: fit-content;align-self: center;">
                                <div class="card-body" style="padding: 1.25rem 0;">
                                    <h4 class="card-title" style="text-align:center">TRUST</h4>
                                    <p class="card-text" style="text-align:center">Build strong relations with all stakeholders - customers, employees, and our business partners based on commitment and trust</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4" style="margin: 10px 0px;">
                            <div class="card" style="padding: 1.25rem;min-height:362px">
                                <img src="https://cdn.chemtradeasia.com/cms/Group 14.png" alt="Card image" style="width: fit-content;align-self: center;">
                                <div class="card-body" style="padding: 1.25rem 0;">
                                    <h4 class="card-title" style="text-align:center">INTEGRITY</h4>
                                    <p class="card-text" style="text-align:center">We do business honestly in accordance to our values</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4" style="margin: 10px 0px;">
                            <div class="card" style="padding: 1.25rem;min-height:362px">
                                <img src="https://cdn.chemtradeasia.com/cms/Group 15.png" alt="Card image" style="width: fit-content;align-self: center;">
                                <div class="card-body" style="padding: 1.25rem 0;">
                                    <h4 class="card-title" style="text-align:center">COMMITMENT</h4>
                                    <p class="card-text" style="text-align:center">We are accountable for our duties with high professionalism to all our stakeholders</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4" style="margin: 10px 0px;">
                            <div class="card" style="padding: 1.25rem;min-height:362px">
                                <img src="https://cdn.chemtradeasia.com/cms/Group 16.png" alt="Card image" style="width: fit-content;align-self: center;">
                                <div class="card-body" style="padding: 1.25rem 0;">
                                    <h4 class="card-title" style="text-align:center">SUSTAINABILITY</h4>
                                    <p class="card-text" style="text-align:center">We do business honestly in accordance to our values</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4" style="margin: 10px 0px;">
                            <div class="card" style="padding: 1.25rem;min-height:362px">
                                <img src="https://cdn.chemtradeasia.com/cms/Group 17.png" alt="Card image" style="width: fit-content;align-self: center;">
                                <div class="card-body" style="padding: 1.25rem 0;">
                                    <h4 class="card-title" style="text-align:center">ENTREPRENEURSHIP</h4>
                                    <p class="card-text" style="text-align:center">Act with entrepreneurship to grow together with all our stakeholders - customers, employees and business partners</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4" style="margin: 10px 0px;">
                            <div class="card" style="padding: 1.25rem;min-height:362px">
                                <img src="https://cdn.chemtradeasia.com/cms/Group 18.png" alt="Card image" style="width: fit-content;align-self: center;">
                                <div class="card-body" style="padding: 1.25rem 0;">
                                    <h4 class="card-title" style="text-align:center">PARTNERSHIP</h4>
                                    <p class="card-text" style="text-align:center">Treasure teamwork and develop strong cooperation to create excellent solutions for all our customers and business partners</p>
                                </div>
                            </div>
                        </div>
                    </div>
