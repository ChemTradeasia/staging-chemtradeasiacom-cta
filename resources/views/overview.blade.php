...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <section style="margin-top:70px">
            <div class="container-fluid" style="padding:0px">
                <div class="banner" style="position:relative;">
                    <center><img alt="Newsletter" src="https://www.plastradeasia.com//view/themes/plastrad/images/Overview.png" style="width:100%" /></center>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="column-value" style="margin:10px 0px">
                        ...
                        <div class="column-value" style="background-color:#123C69;margin:10px 0px">
                            <div style="background:transparent;"><img align="left" alt="images" src="https://www.plastradeasia.com//view/themes/plastrad/images/8.png" style="margin-left:50px;margin:10px 20px 10px 20px;width: 100px;">
                                <h4 style="text-align:left;margin-top:25px;color:white"><b>Systematization of Trading & Shipping Process</b></h4>
        ...
        <section style="padding:20px 0px">
            <div class="container">
                <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b>Company Profile</b></h2>
                <hr style="text-align:center;width:10%;border-top:5px solid #113c69" />
                <div class="row">
                    <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                        <p style="text-align:justify;">Download the company profile brochure to learn about the business model, history, and brief information on our company Tradeasia International as one of the leading chemical suppliers.</p>
                    </div>
                    <div class="col-sm-12 col-md-7 col-lg-7 col-xl-7">
                        <a class="gallery-item2" href="https://cdn.chemtradeasia.com/uploads/1603681327-Tradeasia%20International%20Company%20Profile%20(ENGLISH).pdf">
                            <img alt="Tradeasia Int - Company Profile EN" src="https://cdn.chemtradeasia.com/uploads/Tradeasia-Company-Profile-English-Cover.jpg" style="width: 100%;" />
                        </a>
                    </div>
                </div>
            </div>
