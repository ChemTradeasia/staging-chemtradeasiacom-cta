...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <section style="margin-top:70px">
            <div class="container" style="padding:0px">
                <div class="banner" style="position:relative;">
                    <center><img alt="Newsletter" src="https://cdn.chemtradeasia.com/cms/marketSpread.png" style="width:100%" /></center>
                </div>
            </div>
        </section>
        ...
        <section style="padding:20px 0px">
            <div class="container">
                <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b>Global Market Spread of Tradeasia International</b></h2>
                <hr style="text-align:center;width:10%;border-top:5px solid #113c69;" />            
                <div style="background-color:#123C69;color:white;padding:20px 50px;width:100%; margin-top : 60px;">
                    <h2 class="tulisan">The Presence of Tradeasia as a Chemical Trading Company</h2>            
                    <p>At the beginning of our establishment, Tradeasia International focused to develop the business in the South East Asia region. Our company has been partnering with top industrial chemical suppliers from several countries such as China, India, Thailand, Indonesia, and many more. Tradeasia International specializes in the distribution of both liquid and solid chemicals to industries across South East Asia using these chemicals as raw materials in their production.</p>
                    <p>Tradeasia International has customers from various industries, which include pulp and paper, soap and detergents, textile, foods, plastics, and palm industry. Being aware of the extent of our customer demand, we are focused to be equipped with our broad network around the Asia Pacific and widen our partnership with suppliers from Europe and the USA. Tradeasia International guarantees the right solution to answer every customer&#39;s needs.</p>            
                    <h2 class="tulisan">Road Ahead - Market Expansion</h2>            
                    <p>Over many years, we are slowly and steadily growing to new markets such as the Middle East, Latin America, Africa, and Eastern Europe. Seeing the potential of good resources in each country, we take all available opportunities to be able to work with suppliers who offer quality chemicals. Today, we have more than 400 customers and collaborate with the best chemical suppliers and manufacturers around the world. We specialize in distributing more than 500 quality chemical products, with the most competitive pricing, timely delivery, flexible payment terms, and with utmost dedication.</p>
                </div>
            </div>
        </section>
